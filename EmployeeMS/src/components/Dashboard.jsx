        ...
        <div className='row flex-nowrap'>
            <div className='col-auto col-md-3 col-xl-2 px-0 bg-dark'>
             <div className='d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100'>
                ...
                Code With Oroboss</Link>
             
                <ul id='menu' className='nav nav-pills flex-column mb-sm-auto mb-0 aligh-items-center'>
                    <li className='w-100'> 
                        ...
                        <li className='w-100'> 
                             ...
                             <span className='ms-2 d-none d-sm-inline'>Manage Employees</span></Link>
                             </li>
                             <li className='w-100'> 
                             ...
                             </li>  <li className='w-100' onClick={handleLogout}> 
                             <Link className='nav-link text-white px-0 align-middle'>
                             <i className='fs-4 bi-power ms-2'></i>
                             <span className='ms-2 d-none d-sm-inline'>Sign Out</span></Link>
                             </li>
                </ul>
                </div>
                </div>
